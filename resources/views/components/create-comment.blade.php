<form action="#" class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg m-1 w-2/5">
    <h2 class="p-6 text-gray-900 dark:text-gray-100 text-xl underline">
        {{ __('Send Comment') }}
    </h2>
    <div>
        <div class="flex flex-col">
            <textarea rows="4" id="message" class="px-3 py-2 border shadow-sm sm:rounded-lg
                ...
                text-gray-900 dark:text-gray-100 m-3" placeholder=" {{ __('Write comment...') }}"></textarea>
        </div>
    </div>
    <div class="pt-3 m-3">
        <button type="submit"
